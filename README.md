...
| 1. 설정 메뉴 진입 | 2. 대화내용 내보내기 | 3. 모든 메시지 저장 | 4. PC로 전송 |
|:---:|:---:|:---:|:---:|
| ![설정](img/extract1.PNG) | ![내보내기](img/extract2.PNG) | ![저장](img/extract3.PNG) | ![전송](img/extract4.PNG) |
| 오픈채팅방에서 설정 메뉴(⚙️)로 들어갑니다 | 대화내용 내보내기 선택 | 모든 메시지 저장하기 선택 | 폰에 저장된 압축파일을 PC로 전송 |

### Step 2: 뷰어에서 대화 보기

| 5. 압축파일 업로드 | 6. 날짜 선택하여 복기 |
|:---:|:---:|
| ![업로드](img/step1.png) | ![복기](img/step2.png) |
| PC로 전송한 압축파일을 업로드합니다 | 분석이 끝나면 날짜를 선택하여 대화를 복기합니다 |
...
├── img/                # 사용 가이드 스크린샷
├── parse_kakao_chat.py # 대화 파서 (Python, 대안)
